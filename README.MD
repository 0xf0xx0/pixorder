...
![row sort](./examples/webb-random.jpg)
...
`pixelsort_go --input ~/Downloads/potm2310a.jpg --mask ./examples/webb-mask.jpg --pattern spiral --output ./examples/webb-spiral.jpg`
